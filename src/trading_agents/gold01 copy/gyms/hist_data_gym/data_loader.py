...
class DataLoader(object):
    def __init__(self, instrument_list, primary_intrument, granularity, observation_period=None, from_datetime=None, to_datetime=None, episode_steps=None):
        ...
        hist_data = hist_data.rename(columns={'open': 'open'+str(primary_intrument) ,'high': 'open'+str(primary_intrument), 'low': 'open'+str(primary_intrument), 'close': 'open'+str(primary_intrument)})
