...
class Gym(object):
    def __init__(self, instrument_list, primary_intrument, granularity_list, primary_granularity, input_period_list, from_datetime, to_datetime, episode_steps, reward_calculator, concurrent_episodes, cuda, verbose=True):
        ...
        self.dataloader = DataLoader(instrument_list, primary_intrument, granularity_list, primary_granularity, input_period_list, from_datetime, to_datetime, episode_steps+1, cuda=cuda)
        self.cuda = cuda
