...
class InputDataPreProcessor:
    def __init__(self, concurrent_episodes, data_length=96, recent_log_returns_length=8, normalize_length=96, cuda=False):
    ...
    def patchRecentLogReturns(self, x):
        ...
        #     raise
        close_index = 3
        close_index_tensor = x[:, :, close_index]
        time_features_tensor = x[:, -self.data_length:, 4:]
